...
function HomeBanner() {
  ...
  const items = [
    <div data-value="1" key={1} className="w-full ">
      <section
        className="w-full bg-cover bg-center relative overflow-hidden pt-28"
        style={{
          backgroundImage:
            "url('https://quomodothemes.website/html/quland-html/assets/images/home-five/hero/bg.webp')",
        }}
      >
